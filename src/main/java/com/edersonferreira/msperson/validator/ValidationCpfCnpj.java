...
public class ValidationCpfCnpj {
	...
	public ValidationCpfCnpj() {
	}

	public ValidationCpfCnpj(String numberDoc) {
	...
	public void setNumber(String numberDoc) {
		this.numberDoc = numberDoc;
	}
	
	public boolean documentIsValid() {
		return numberDoc == null || numberDoc.isEmpty() || isCpf() || isCnpj();
	}
	
	public boolean isCpf() {
		String cpf = numberDoc.replace(".", "");
		cpf = cpf.replace("-", "");
